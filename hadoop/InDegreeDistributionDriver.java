...
public class InDegreeDistributionDriver {
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: InDegreeDistribution <input> <temp> <output>");
            System.exit(-1);
        }
        ...
        job1.setJarByClass(InDegreeDistributionDriver.class);
        ...
        job2.setJarByClass(InDegreeDistributionDriver.class);
