...
public class TwitterHashtagCounterScaling {
    ...
    public static class HashtagExtractor implements FlatMapFunction<String, Tuple2<String, Integer>> {
        ...
        public void flatMap(String value, Collector<Tuple2<String, Integer>> out) throws Exception {
            ...
            try {
                ...
                // EXTRACT FROM DESCRIPTION TEXT (same approach as Facebook)
        ...
        private void printMetrics() {
            ...
            System.out.println("\n" + "=".repeat(60));
            System.out.println(" TWITTER STEP 4 METRICS (Messages: " + totalMessages + ") 🐦");
    ...
    private static JsonNode loadConfig() throws Exception {
        ...
        InputStream configStream = TwitterHashtagCounterScaling.class.getClassLoader().getResourceAsStream("config.yml");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String twitterGroup = config.path("kafka").path("consumer_groups").path("twitter").asText("twitter-counter-step4");
        ...
        System.out.println("=== TWITTER HASHTAG COUNTER STEP 4 CONFIGURATION ===");
        ...
        hashtagCounts.print("TWITTER_STEP4_HASHTAG_COUNTS");

        env.execute("Twitter Hashtag Counter - Step 4 Scaling");
    }
}